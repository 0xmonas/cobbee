        ...
        headers: [
          // Content Security Policy - Allow Reown/WalletConnect, Vercel, and necessary scripts
          {
            ...
            value: [
              ...
              `connect-src 'self' ${supabaseUrl} https://*.walletconnect.com https://*.walletconnect.org wss://*.walletconnect.com wss://*.walletconnect.org https://relay.walletconnect.com wss://relay.walletconnect.com https://rpc.walletconnect.com https://pulse.walletconnect.com https://api.web3modal.org https://api.web3modal.com https://cca-lite.coinbase.com https://sepolia.base.org https://mainnet.base.org https://base-sepolia.blockpi.network https://base.blockpi.network https://x402.org https://facilitator.x402.rs https://api.cdp.coinbase.com https://vercel.live`,
